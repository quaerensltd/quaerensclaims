...
const pages = ["public/airbnb-refunds.html", "public/section75support.html", "public/freeholidaycompensation.html", "public/freeflightclaim.html", "public/lost-luggage.html"].map(read);
const checks = [
  ...
  [runtime.includes("frameworkVersion: window.QCBFrameworkACategories.version") && component.includes("function metadata(root)"), "Framework C/B handoff metadata is exposed"],
  ...
  [pages.every((html) => html.includes("/airbnb-complaint-pack-v3.js?v=1.5.0")), "all certified builders load the same versioned runtime"],
