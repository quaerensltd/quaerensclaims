...
(async () => {
  await rejectsCode(() => recordFrameworkAMetric.run({ auth: null, rawRequest: { headers: {} }, data: { builder: "unknown", event: "pack_started", frameworkVersion: "1.3", deviceClass: "desktop" } }), "invalid-argument");
  await rejectsCode(() => recordFrameworkAMetric.run({ auth: null, rawRequest: { headers: {} }, data: { builder: "airbnb", event: "unknown", frameworkVersion: "1.3", deviceClass: "desktop" } }), "invalid-argument");
  await rejectsCode(() => recordFrameworkAMetric.run({ auth: null, rawRequest: { headers: {} }, data: { builder: "airbnb", event: "pack_started", frameworkVersion: "1.3", deviceClass: "desktop", count: 100 } }), "invalid-argument");
  await rejectsCode(() => recordFrameworkAMetric.run({ auth: null, rawRequest: { headers: { "content-length": "3000" } }, data: { builder: "airbnb", event: "pack_started", frameworkVersion: "1.3", deviceClass: "desktop" } }), "invalid-argument");
