...
assert.ok(page.includes('class="qcb-builder-wrap" data-qcb-builder="train"'));
assert.ok(page.includes('class="qcb-builder qcb-framework-v1 qcb-airbnb-builder"'));
assert.ok(page.includes('class="qcb-form qcb-airbnb-stage"'));
assert.ok(page.includes('class="qcb-preview qcb-airbnb-preview"'));
assert.ok(page.includes('src="/airbnb-complaint-pack-v3.js'));
assert.ok(page.includes('src="/complaint-builder/adapters/framework-a-train-adapter-v1.6.js'));
assert.ok(!page.includes('id="train-builder-modern-styles"'));
assert.ok(!page.includes('src="builders/train/train.page.js"'));
